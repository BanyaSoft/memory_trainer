...
begin
  ...
  begin
    ...
    begin
      ...
      writeln('Этап 2. Уровень ', level, #13#10, 'Введите словa в любом порядке:');
...
begin
  ...
  begin
    ...
    begin
      ...
      writeln('Этап 3. Уровень ', level, #13#10, 'Введите словa в строгом порядке:');
...
begin
  ...
  begin
    ...
    begin
      ...
      writeln('Этап 4. Уровень ', level, #13#10, 'Введите перевёрнутые словa в любом порядке:');
...
begin
  ...
  begin
    ...
    begin
      ...
      writeln('Этап 5. Уровень ', level, #13#10, 'Введите предложение в обратном порядке:');
